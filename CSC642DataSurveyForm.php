...
<head>
    ...
    <script type="text/javascript" src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/fonts/glyphicons-halflings-regular.woff2"></script>
    <!-- Bootstrap Validator -->
...
<body>
    ...
    <div class="container center-div">
        <div class="container jumbotron jumbotron-fluid" id="main-container">
            <div class="container center-div">
                <div class="col-lg-12">
                    <form id="surveyForm" method="post" action="verify.php" data-toggle="validator">
                        <div class="row">
                            <div class="wrapper">
